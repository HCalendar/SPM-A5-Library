<template>
  <div>
    <div id="myTimer" style="text-align: center;font-weight: 550;line-height: 50px;"></div>
    <el-row :gutter="20">
...
export default {
  ...
  data() {
    return {
      cards: [
        {title: 'Borrowed Times', data: 100, icon: '#iconlend-record-pro'},
        {title: 'Total Visits Today', data: 100, icon: '#iconvisit'},
  ...
  mounted() {
    ...
    request.get("http://localhost:8181/dashboard").then(res => {
      if (res.code == 0) {
